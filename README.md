...
<p align="center">
  <em>In the main menu, you can choose your character, weapon and outfit, all of which will affect your stats.</em>
</p>
...
<p align="center">
  <em>In-game, you can see your character's health, ammunition and current mission status.</em>
</p>
...
<p align="center">
  <em>Example of a level in which no sign is required, just an explanation at the start of use of the application (in French).</em>
</p>
...
<p align="center">
  <em>Example of a level in which the user must sign the letter A (LSF).</em>
</p>
...
<p align="center">
  <em>The main menu of the game, the player is in the elevator of the building, to ensure continuity between the menu and the game. The pause menu is also in the elevator.</em>
</p>
...
<p align="center">
  <em>The secretary is making the deal with the player at the beginning of the game (in French).</em>
</p>
...
<p align="center">
  <em>The player is using the copy machine, they can know at any moment the status of the photocopying.</em>
</p>
...
<p align="center">
  <em>The player can hide under desks and tables, so the enemies won't be able to detect them, otherwise they will run to the player.</em>
</p>
...
<p align="center">
  <em>The enemies can also interact with the task object such as copy machine or computer to stop the current task.</em>
</p>
